...
export default function Dashboard() {
  ...
  // We need state (for username) and signOut here
  const { state, signOut } = useAuthContext();

  // 🚨 IMPORTANT: Make sure this is your actual Choreo URL!
  const API_URL = "https://YOUR-CHOREO-URL/football-proxy/v1.0/matches/today";
